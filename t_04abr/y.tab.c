...
{
  "$end", "error", "$undefined", "NUM", "R2R", "'\\n'", "'+'", "'-'",
  "'*'", "'/'", "'!'", "'('", "')'", "$accept", "ax", "e", "p", "f", YY_NULLPTR
};
#endif
...
{
       4,     0,     1,    11,     0,     3,     0,     0,     7,    10,
       0,     0,     2,     0,     0,     0,     0,    12,     0,    13,
       5,     6,     8,     9,    14
};
...
{
       2,     3,     4,     3,     4,     5,    10,    13,    14,     6,
       0,     6,    11,    19,    13,    14,    18,    12,    13,    14,
      24,    15,    16,    20,    21,    17,    22,    23
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,     5,    11,     6,     7,    11,
      -1,    11,     6,    12,     6,     7,    10,     5,     6,     7,
      12,     8,     9,    13,    14,    10,    15,    16
};
...
{
       0,    14,     0,     3,     4,     5,    11,    15,    16,    17,
      11,    15,     5,     6,     7,     8,     9,    10,    15,    12,
      16,    16,    17,    17,    12
};
