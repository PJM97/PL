...
static const char *const yytname[] =
{
  ...
  "READ", "STRING", "':'", "';'", "'='", "','", "'+'", "'-'", "'*'", "'/'",
  "'('", "')'", "$accept", "prog", "decls", "insts", "inst", "exp", "parc",
  "fact", "tipo", YY_NULLPTR
};
#endif
...
{
     -14,     3,    18,   -14,    11,    12,    19,    -3,    16,    14,
     -14,    24,   -14,   -14,    -3,    -6,     8,   -14,    -3,    20,
      21,   -14,    22,   -13,   -14,    -3,    -3,    -3,    -3,    -4,
     -14,    25,   -14,   -14,     8,     8,   -14,   -14,   -14,    26,
     -14
};
...
{
       4,     0,     6,     1,     0,     2,     0,     0,     0,     0,
       5,     0,    18,    17,     0,     0,    13,    16,     0,     0,
       0,    20,     0,     0,     8,     0,     0,     0,     0,     0,
      10,     0,     3,    19,    11,    12,    14,    15,     7,     0,
       9
};
...
{
     -14,   -14,   -14,   -14,   -14,    -2,   -12,    -1,   -14
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     2,     5,    10,    15,    16,    17,    22
};
...
{
      12,    25,    26,     3,    13,    24,    33,    38,    25,    26,
      25,    26,    23,    34,    35,    14,    29,     7,     6,     8,
       9,    19,     4,    20,    27,    28,    36,    37,    18,    11,
      21,    30,    39,    32,    31,     0,     0,    40
};

static const yytype_int8 yycheck[] =
{
       3,    14,    15,     0,     7,    11,    19,    11,    14,    15,
      14,    15,    14,    25,    26,    18,    18,     5,     7,     7,
       8,     7,     4,     9,    16,    17,    27,    28,    12,    10,
       6,    11,     7,    11,    13,    -1,    -1,    11
};
...
{
       0,    21,    22,     0,     4,    23,     7,     5,     7,     8,
      24,    10,     3,     7,    18,    25,    26,    27,    12,     7,
       9,     6,    28,    25,    11,    14,    15,    16,    17,    25,
      11,    13,    11,    19,    26,    26,    27,    27,    11,     7,
      11
};
